...
For homework 2, you will create a dashboard with three visualization views. Specifically, you will be developing a web-based interface in JavaScript with [D3.js](https://d3js.org/), where we have provided three templates.

To begin, you need to first fork this repository.
After the fork, clone the repository using the following commands:

```bash
  git clone https://github.com/<your-github-account-name>/ECS272-Winter2026
  cd ECS272-Winter2026/Homework2 
```
...
### Important tutorials to D3.js (recommended)
 ...
 - We also provide a toy example in our templates.
...
# Submission
To submit for this assignment, you need to first [fork](https://docs.github.com/en/free-pro-team@latest/github/getting-started-with-github/fork-a-repo) this [repository](https://github.com/VIDITeaching/ECS272-Winter2026). After the fork, clone the forked repository using the following commands: 
```bash
  git clone https://github.com/<your-github-account-name>/ECS272-Winter2026
  cd ECS272-Winter2026/Homework2
```
